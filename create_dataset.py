...
framing_data = beauty_negative_terms + beauty_positive_terms + beauty_profession_negative_terms + beauty_profession_positive_terms + beauty_negative_terms_type2 + beauty_positive_terms_type2 + beauty_profession_positive_terms_type2 + beauty_profession_negative_terms_type2 + instituition_positive_terms_type1_set1 + instituition_negative_terms_type1_set1 + instituition_positive_terms_type1_set2 + instituition_negative_terms_type1_set2 + instituition_positive_terms_type2_set1 + instituition_negative_terms_type2_set1 + instituition_positive_terms_type2_set2 + \
    instituition_negative_terms_type2_set2 + nationality_positive_terms_type1 + nationality_negative_terms_type1 + nationality_positive_terms_type2_set1 + nationality_negative_terms_type2_set1 + nationality_positive_terms_type2_set2 + nationality_negative_terms_type2_set2 + \
