...
if __name__ == '__main__':
  ...
  type1_combined_dict = {'bias_type': [], 'positive': [], 'negative': [], 'unrelated': [], 'total': [], 'pl': [],'nl': [],'nul': [], 'del_pl':[], 'del_nl': [], 'del_nul': []}
  for i in range(5):
    ...
    # 增加计算del_pl del_nl del_nul
    del_pos = type1_positive_dict['pos_to_pos'][i] - type1_negative_dict['neg_to_pos'][i]
    type1_combined_dict['del_pl'].append(del_pos)

    del_neg = type1_positive_dict['pos_to_neg'][i] - type1_negative_dict['neg_to_neg'][i]
    type1_combined_dict['del_nl'].append(del_neg)

    del_neu = type1_positive_dict['pos_to_neu'][i] - type1_negative_dict['neg_to_neu'][i]
    type1_combined_dict['del_nul'].append(del_neu)
  ...
  type2_combined_dict = {'bias_type': [], 'positive': [], 'negative': [], 'unrelated': [], 'total': [], 'pl': [],'nl': [],'nul': [], 'del_pl':[], 'del_nl': [], 'del_nul': []}
  for i in range(5):
    ...
    # 增加计算del_pl del_nl del_nul
    del_pos = type2_positive_dict['pos_to_pos'][i] - type2_negative_dict['neg_to_pos'][i]
    type2_combined_dict['del_pl'].append(del_pos)

    del_neg = type2_positive_dict['pos_to_neg'][i] - type2_negative_dict['neg_to_neg'][i]
    type2_combined_dict['del_nl'].append(del_neg)

    del_neu = type2_positive_dict['pos_to_neu'][i] - type2_negative_dict['neg_to_neu'][i]
    type2_combined_dict['del_nul'].append(del_neu)
...
framing_df = pd.read_csv(f'outputs/{filename}')
